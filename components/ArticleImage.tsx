    ...
    <>
      ...
      {isOpen && (
        ...
        >
          <button
            onClick={() => setIsOpen(false)}
            className="absolute top-6 right-6 z-[110] p-3 rounded-none bg-white/20 backdrop-blur-md border border-white/20 text-white hover:bg-white/30 shadow-xl transition-all cursor-pointer"
