  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-full">
        ...
        <div
          className="relative aspect-video lg:aspect-square w-full overflow-hidden rounded-none border border-white/10 shadow-2xl bg-neutral-800/50 max-h-100 md:max-h-125 lg:max-h-125 cursor-zoom-in group"
        ...
        >
          {imageUrl && (
            <Image
              ...
              alt={altText}
              fill
              className="object-cover md:object-contain lg:object-cover py-2 rounded-none transition-transform duration-500 group-hover:scale-[1.02]"
              priority
            />
          )}
        </div>
      ...
      {isLightboxOpen && (
        ...
        >
          ...
          <button
            ...
            className="absolute top-6 right-6 z-[110] p-3 rounded-none bg-white/20 backdrop-blur-md border border-white/20 text-white hover:bg-white/30 shadow-xl transition-all hover:cursor-pointer"
